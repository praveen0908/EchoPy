                ...
                <div className="m-auto overflow-hidden mx-4 mt-8 lg:mt-4 p-2 md:p-12 h-5/6" data-aos="zoom-in">
                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            Experience Personalized Learning with EchoPy
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">In a world overloaded with information, EchoPy simplifies learning by turning complex materials into tailored, easy-to-understand modules, adapting in real-time to user feedback for more effective and engaging education.</div>
